...
public class IllegalAddException extends IllegalArgumentException {
    ...
    public IllegalAddException(Element base, Namespace added, String reason) {
        super(
            "The namespace xmlns" + ((added.getPrefix() == null || added.getPrefix().equals("")) ? "=" : (":" + added.getPrefix() + "="))
            + "\"" + added.getURI() + "\" could not be added as content to \"" + base.getQualifiedName() + "\": " + reason
        );
    }
