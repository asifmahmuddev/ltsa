...
public class XMLOutputter implements Cloneable {
        ...
        if (start < content.size()) {
            ...
            for (int i = start; i < end; i++) {
                ...
                if (next != null && !"".equals(next)) {
                    if (
                        previous != null && (this.currentFormat.textNormalize || this.currentFormat.textTrim)
    ...
    public String toString() {
        ...
        + this.omitEncoding + ", " + "indent = '" + this.defaultFormat.indent + "'" + ", " + "expandEmptyElements = "
        + this.defaultFormat.expandEmptyElements + ", " + "newlines = " + this.defaultFormat.newlines + ", " + "lineSeparator = '"
        + buffer.toString() + "', " + "trimAllWhite = " + this.defaultFormat.trimAllWhite + "textTrim = " + this.defaultFormat.textTrim
