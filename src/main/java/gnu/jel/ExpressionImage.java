...
public class ExpressionImage {
    ...
    public static final String[] binaryNames = new String[]{
        "add", "substract", "multiply", "divide", "remainder", "bitwise and", "bitwise or", "bitwise xor", "equal", "not equal", "less",
    ...
    private static final byte[] cp_middle = new byte[]{
        7, 1, 1, 26, 103, 110, 117, 47, 106, 101, 108, 47, 67, 111, 109, 112, 105, 108, 101, 100, 69, 120, 112, 114, 101, 115, 115, 105,
        111, 110, 7, 3, 1, 1, 101, 1, 19, 91, 76, 106, 97, 118, 97, 47, 108, 97, 110, 103, 47, 79, 98, 106, 101, 99, 116, 59, 1, 6, 60,
        105, 110, 105, 116, 62, 1, 22, 40, 91, 76, 106, 97, 118, 97, 47, 108, 97, 110, 103, 47, 79, 98, 106, 101, 99, 116, 59, 41, 86, 1,
        10, 69, 120, 99, 101, 112, 116, 105, 111, 110, 115, 1, 4, 67, 111, 100, 101, 1, 3, 40, 41, 86, 12, 7, 11, 10, 4, 12, 12, 5, 6, 9,
        2, 14, 1, 7, 103, 101, 116, 84, 121, 112, 101, 1, 3, 40, 41, 73, 1, 19, 106, 97, 118, 97, 47, 108, 97, 110, 103, 47, 84, 104, 114,
        111, 119, 97, 98, 108, 101, 7, 18
    };
    private static final byte[] intermezzo1 = new byte[]{
        0, 33, 2, 4, 1, 2, 5, 6, 3, 1, 7, 8, 2, 9, 2, 10, 22, 2, 2, 10, 42, -73, 13, 42, 43, -75, 15, -79, 1, 16, 17, 2, 9, 2, 10, 15, 1,
        1, 3, 16
    };
    ...
    public static final Class[] primitiveTypes = new Class[]{
    ...
    private static final int[][] cvt1 = new int[][]{
        {0, 255, 255, 255, 255, 255, 255, 255}, {145, 145, 145, 145, 136, 139, 142}, {146, 146, 146, 146, 136, 139, 142},
        {147, 147, 147, 147, 136, 139, 142}, {0, 0, 0, 0, 0, 136, 139, 142}, {133, 133, 133, 133, 133, 140, 143},
        {134, 134, 134, 134, 134, 137, 144}, {135, 135, 135, 135, 135, 138, 141}
    };
    private static final int[][] cvt2 = new int[][]{
        new int[8], {0, 0, 0, 0, 0, 145, 145, 145}, {0, 0, 0, 0, 0, 146, 146, 146}, {0, 0, 0, 0, 0, 147, 147, 147},
    ...
    private static final int[][] binary_promotions = new int[][]{
        {0, 255, 255, 255, 255, 255, 255, 255}, {255, 4, 4, 4, 4, 5, 6, 7}, {255, 4, 4, 4, 4, 5, 6, 7}, {255, 4, 4, 4, 4, 5, 6, 7},
    ...
    private static final int[][][] ops = new int[][][]{
        {
            {255, 96, 255, 96, 96, 97, 98, 99}, {255, 100, 255, 100, 100, 101, 102, 103}, {255, 104, 255, 104, 104, 105, 106, 107},
            {255, 108, 255, 108, 108, 109, 110, 111}, {255, 112, 255, 112, 112, 113, 114, 115}, {126, 126, 255, 126, 126, 127, 255, 255},
            {128, 128, 255, 128, 128, 129, 255, 255}, {130, 130, 255, 130, 130, 131, 255, 255}, {0, 0, 0, 0, 0, 148, 150, 152},
            {0, 0, 0, 0, 0, 148, 150, 152}, {0, 0, 0, 0, 0, 148, 150, 152}, {0, 0, 0, 0, 0, 148, 149, 151}, {0, 0, 0, 0, 0, 148, 149, 151},
            {0, 0, 0, 0, 0, 148, 150, 152}, {120, 120, 120, 120, 120, 121, 255, 255}, {122, 122, 122, 122, 122, 123, 255, 255},
            {124, 124, 124, 124, 124, 125, 255, 255}
        }
    };
    ...
    private static final int[][] openjumps = new int[][]{
        new int[8], new int[8], new int[8], new int[8], new int[8], new int[8], new int[8], new int[8],
        {159, 159, 159, 159, 159, 153, 153, 153}, {160, 160, 160, 160, 160, 154, 154, 154}, {161, 161, 161, 161, 161, 155, 155, 155},
        {162, 162, 162, 162, 162, 156, 156, 156}, {163, 163, 163, 163, 163, 157, 157, 157}, {164, 164, 164, 164, 164, 158, 158, 158},
        new int[8], new int[8], new int[8]
    };
    private static final int[] norm = new int[]{0, 145, 146, 147};
    private static final int[][][] una = new int[][][]{
        {{116, 116, 255, 116, 116, 117, 118, 119}, {255, 2, 2, 2, 2, 2, 255, 255}},
        {new int[8], {0, 130, 130, 130, 130, 133}}, {new int[8], {0, 0, 0, 0, 0, 131}}
    };
    ...
    public static String getSignature(Class paramClass) {
        return paramClass.isPrimitive()
            ...
            : (paramClass.isArray()
                ? (String.valueOf('[') + getSignature(paramClass.getComponentType()))
                : (String.valueOf('L') + toHistoricalForm(paramClass.getName()) + ';'));
    }
    ...
    private void logical_param(
        boolean paramBoolean, IntegerStack paramIntegerStack1, IntegerStack paramIntegerStack2, IntegerStack paramIntegerStack3,
        IntegerStack paramIntegerStack4
    ) {
        ensure_jump();
