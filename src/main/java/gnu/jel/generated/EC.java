...
public class EC implements ECConstants {
    ...
    private final int[] jj_la1_0 = new int[]{
        0, 16384, 4096, 8192, 32768, 2048, 196608, 196608, 3932160, 3932160, 29360128, 29360128, 48, 48, 1792, 1792, 224,
        -1912602624, -1912602624, -1912602400, -2013265920
    };
        ...
        return jj_scan_token(40)
            ...
            : ((this.jj_la == 0 && this.jj_scanpos == this.jj_lastpos)
                ...
                : (jj_scan_token(35)
                    ...
                    : ((this.jj_la == 0 && this.jj_scanpos == this.jj_lastpos)
                        ? false
                        : (jj_scan_token(41) ? true : ((this.jj_la == 0 && this.jj_scanpos == this.jj_lastpos) ? false : false)))));
    }
                ...
                if (!bool) {
                    if (l <= 127L) {
                        ...
                        throw new CompilationException(
                            this.token, "Integer number \"" + this.token.image + "\" is too large for type 'int'. Be sure" + " to add 'L' suffix to use 'long' type."
                        );
                    }
                } else {
