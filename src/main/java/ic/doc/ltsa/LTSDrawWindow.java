    ...
    class PrintAction implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent param1ListSelectionEvent) {
            ...
            if (LTSDrawWindow.singleMode) {
                this.this$0.output.draw(
                    i, this.this$0.sm[i], this.this$0.validMachine(i, this.this$0.prevEvent),
                    this.this$0.validMachine(i, this.this$0.lastEvent), this.this$0.lastName
                );
            } else {
