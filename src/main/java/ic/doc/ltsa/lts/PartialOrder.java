...
public class PartialOrder {
    ...
    public PartialOrder(
        Hashtable paramHashtable, String[] paramArrayOfString, CompactState[] paramArrayOfCompactState, StackChecker paramStackChecker,
        Vector paramVector, boolean paramBoolean1, boolean paramBoolean2, BitSet paramBitSet
    ) {
