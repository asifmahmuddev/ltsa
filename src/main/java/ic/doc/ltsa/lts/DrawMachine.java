...
public class DrawMachine implements Exportable {
    ...
    protected Dimension computeDimension(CompactState paramCompactState) {
        ...
        i1 = i1 + b3 * n + 10;
        int i2 = (this.errorState == 0)
            ? (10 + this.nameWidth + 30 + j + (paramCompactState.maxStates - 1) * this.SEPARATION)
            : (40 + j + paramCompactState.maxStates * this.SEPARATION);
                ...
                while (eventState != null) {
                    ...
                    if (str.charAt(0) != '@')
                        while (eventState1 != null) {
                            arrayOfInt[eventState1.next + 1] = arrayOfInt[eventState1.next + 1] + 1;
                            drawTransition(
                                paramGraphics, b1, eventState1.next, str, arrayOfInt[eventState1.next + 1],
                                (b1 == this.lastselected && eventState1.next == this.selected), false
                            );
                            eventState1 = eventState1.nondet;
                        }
                    eventState = eventState.list;
                ...
                while (eventState != null) {
                    ...
                    if (str.charAt(0) != '@')
                        while (eventState1 != null) {
                            ...
                            if (!this.newLabelFormat) {
                                drawTransition(
                                    paramGraphics, b2, eventState1.next, str, arrayOfInt[eventState1.next + 1],
    ...
    private void drawTransition(
        Graphics paramGraphics, int paramInt1, int paramInt2, String paramString, int paramInt3, boolean paramBoolean1, boolean paramBoolean2
    ) {
        if (paramBoolean1) {
            paramGraphics.setColor(Color.red);
        } else {
    ...
    public DrawMachine(
        CompactState paramCompactState, JPanel paramJPanel, Font paramFont1, Font paramFont2, boolean paramBoolean1, boolean paramBoolean2,
