...
public class Analyser implements Animator, Automata, WebAnimator {
    ...
    private void outStatistics(int paramInt1, int paramInt2) {
        ...
        this.output.outln(
            "-- States: " + paramInt1 + " Transitions: " + paramInt2 + " Memory used: "
            + ((runtime.totalMemory() - runtime.freeMemory()) / 1000L) + "K"
        );
    }
    ...
    private int newState_compose() {
        ...
        if (partialOrderReduction)
            this.partial = new PartialOrder(
                this.alphabet, this.actionName, this.sm, new StackChecker(this.coder, this.analysed), this.cs.hidden,
                this.cs.exposeNotHide, preserveObsEquiv, this.highAction
            );
    ...
    private int newState_analyse(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
        ...
        if (partialOrderReduction)
            this.partial = new PartialOrder(
                this.alphabet, this.actionName, this.sm, new StackChecker(this.coder, myHashQueue), this.cs.hidden,
                this.cs.exposeNotHide, false, this.highAction
            );
    ...
    public void setStackChecker(StackCheck paramStackCheck) {
        if (partialOrderReduction)
            this.partial = new PartialOrder(
                this.alphabet, this.actionName, this.sm, new StackChecker(this.coder, paramStackCheck), this.cs.hidden,
                this.cs.exposeNotHide, false, this.highAction
            );
    }
