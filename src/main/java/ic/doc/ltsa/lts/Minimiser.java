...
public class Minimiser {
    ...
    private CompactState makeNewMachine() {
        ...
        if (this.machine.endseq < 0) {
            ...
            compactState.states[compactState.endseq] = EventState.remove(
                compactState.states[compactState.endseq], new EventState(compactState.alphabet.length, compactState.endseq)
            );
        }
