...
class BeanUtil {
    ...
    static void setProperty(
        Object paramObject, BeanInfo paramBeanInfo, String paramString1, String paramString2, ValueParser paramValueParser
    ...
    static void setIndexedProperty(
        Object paramObject, BeanInfo paramBeanInfo, String paramString1, int paramInt, String paramString2,
        ValueParser paramValueParser
    ) throws AnimationParseException {
        PropertyDescriptor propertyDescriptor = getPropertyDescriptor(paramBeanInfo, paramString1);
