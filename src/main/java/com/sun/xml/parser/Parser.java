...
public class Parser implements Parser {
    ...
    private void parseInternal(InputSource paramInputSource) throws SAXException, IOException {
        ...
        try {
            ...
            throw new SAXParseException(
                (runtimeException.getMessage() != null) ? runtimeException.getMessage() : runtimeException.getClass().getName(),
                this.locator.getPublicId(), this.locator.getSystemId(), this.locator.getLineNumber(), this.locator.getColumnNumber(), 
                runtimeException
            );
        } finally {
            this.strTmp = null;
    ...
    private boolean maybeElement(ElementValidator paramElementValidator) throws IOException, SAXException {
        ...
        while (!this.in.peekc('>')) {
            ...
            this.attTmp.addAttribute(
                str1, (attributeDecl == null) ? "CDATA" : attributeDecl.type,
                str2, (attributeDecl == null) ? null : attributeDecl.defaultValue, true
            );
            bool1 = true;
        }
        if (elementDecl != null)
    ...
    private void expandEntityInContent(
        ElementDecl paramElementDecl, String paramString, ElementValidator paramElementValidator
    ...
    private boolean externalParsedEntity(
        ElementDecl paramElementDecl, ExternalEntity paramExternalEntity, ElementValidator paramElementValidator
    ...
    private void nextChar(char paramChar, String paramString1, String paramString2) throws IOException, SAXException {
        ...
        if (!this.in.peekc(paramChar))
            fatal(
                "P-008", new Object[]{
                    new Character(paramChar), messages.getMessage(this.locale, paramString1),
    ...
    private void fatal(String paramString, Object[] paramArrayOfObject, Exception paramException) throws SAXException {
        SAXParseException sAXParseException = new SAXParseException(
            messages.getMessage(this.locale, paramString, paramArrayOfObject), this.locator, paramException
        );
    ...
    static class ListenerBase extends HandlerBase implements DtdEventListener, LexicalEventListener {
        ...
        public void attributeDecl(
            String param1String1, String param1String2, String param1String3, String[] param1ArrayOfString, String param1String4,
    ...
    static final class Catalog extends MessageCatalog {
        Catalog() {
            super((Parser.class$com$sun$xml$parser$Parser != null)
                ? Parser.class$com$sun$xml$parser$Parser
                : (Parser.class$com$sun$xml$parser$Parser = Parser.class$("com.sun.xml.parser.Parser")));
        }
    }
}
