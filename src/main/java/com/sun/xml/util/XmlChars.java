...
public class XmlChars {
    public static boolean isChar(int paramInt) {
        return !(
            (paramInt < 32 || paramInt > 55295) && paramInt != 10 && paramInt != 9 && paramInt != 13
            && (paramInt < 57344 || paramInt > 65533) && (paramInt < 65536 || paramInt > 1114111)
        );
    }
    ...
    private static boolean isCompatibilityChar(char paramChar) {
        switch (paramChar >> 8 & 0xFF) {
            ...
            case 1 :
                return !(
                    (paramChar < 'Ĳ' || paramChar > 'ĳ') && (paramChar < 'Ŀ' || paramChar > 'ŀ')
                    && paramChar != 'ŉ' && paramChar != 'ſ' && (paramChar < 'Ǆ' || paramChar > 'ǌ')
            ...
            case 17 :
                return !(
                    paramChar != 'ᄁ' && paramChar != 'ᄄ' && paramChar != 'ᄈ' && paramChar != 'ᄊ' && paramChar != 'ᄍ'
                    && (paramChar < 'ᄓ' || paramChar > 'ᄻ') && paramChar != 'ᄽ' && paramChar != 'ᄿ' && (paramChar < 'ᅁ' || paramChar > 'ᅋ')
                    && paramChar != 'ᅍ' && paramChar != 'ᅏ' && (paramChar < 'ᅑ' || paramChar > 'ᅓ') && (paramChar < 'ᅖ' || paramChar > 'ᅘ')
                    && paramChar != 'ᅢ' && paramChar != 'ᅤ' && paramChar != 'ᅦ' && paramChar != 'ᅨ' && (paramChar < 'ᅪ' || paramChar > 'ᅬ')
                    && (paramChar < 'ᅯ' || paramChar > 'ᅱ') && paramChar != 'ᅴ' && (paramChar < 'ᅶ' || paramChar > 'ᆝ')
                    && (paramChar < 'ᆟ' || paramChar > 'ᆢ') && (paramChar < 'ᆩ' || paramChar > 'ᆪ') && (paramChar < 'ᆬ' || paramChar > 'ᆭ')
                    && (paramChar < 'ᆰ' || paramChar > 'ᆶ') && paramChar != 'ᆹ' && paramChar != 'ᆻ' && (paramChar < 'ᇃ' || paramChar > 'ᇪ')
                    && (paramChar < 'ᇬ' || paramChar > 'ᇯ') && (paramChar < 'ᇱ' || paramChar > 'ᇸ')
                );
            case 32 :
                return !(paramChar != 'ⁿ');
            case 33 :
                if (
                    paramChar != 'ℂ' && paramChar != 'ℇ' && (paramChar < 'ℊ' || paramChar > 'ℓ') && paramChar != 'ℕ'
                    && (paramChar < '℘' || paramChar > 'ℝ') && paramChar != 'ℤ' && paramChar != 'ℨ' && (paramChar < 'ℬ' || paramChar > 'ℭ')
                    && (paramChar < 'ℯ' || paramChar > 'ℸ')
                )
    ...
    private static boolean isExtender(char paramChar) {
        return !(
            paramChar != '·' && paramChar != 'ː' && paramChar != 'ˑ' && paramChar != '·' && paramChar != 'ـ' && paramChar != 'ๆ'
            && paramChar != 'ໆ' && paramChar != '々' && (paramChar < '〱' || paramChar > '〵') && (paramChar < 'ゝ' || paramChar > 'ゞ')
            && (paramChar < 'ー' || paramChar > 'ヾ')
        );
    }
}
